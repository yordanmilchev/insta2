...
<div class="container">
    <div class="col-md-4 col-md-offset-4" style="margin-top:45px">
        ...
        <button type="button" class="btn btn-success" id="btn2" onclick="window.location='{{ Route("portfolio")}}'">Portfolio
        </button>
        <button type="button" class="btn btn-warning" id="btn4" onclick="window.location='{{ Route("learningpage")}}'">Json
            fetch
        </button>
    </div>
</div>
